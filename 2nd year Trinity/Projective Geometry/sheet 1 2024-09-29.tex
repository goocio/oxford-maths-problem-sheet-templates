...
\part%1c
Show that those projective transformations in $\operatorname{PGL}(3, \mathbb{F})$ which map the line at infinity to itself form a subgroup of $\operatorname{PGL}(3, \mathbb{F})$ which is isomorphic to \[
...
\begin{parts}
\part%4a
List the elements of $\operatorname{PGL}\left(2, \mathbb{F}_2\right)$. What is the order of $\operatorname{PGL}(2, \mathbb{F})$ if $|\mathbb{F}|=q$?

\part%4b
By considering the action of $\operatorname{PGL}\left(2, \mathbb{F}_2\right)$ on $\mathbb{F}_2 \mathbb{P}^1$, show that $\operatorname{PGL}\left(2, \mathbb{F}_2\right) \cong S_3$. Is $\operatorname{PGL}\left(2, \mathbb{F}_3\right) \cong S_4$? Is $\operatorname{PGL}\left(2, \mathbb{F}_5\right) \cong S_6$?
\end{parts}
...
\begin{parts}
\part%7a
Let $\tau \in \operatorname{PGL}(2, \mathbb{C})$, other than the identity. Show that $\tau$ fixes either one or two points. Show that this need not be true over other fields.
...
\part%7c
Let $A_1, A_2, A_3$ be three distinct points in $\mathbb{C P}^1$ and let $n \geqslant 3$ be an integer. Show that there is $\tau \in \operatorname{PGL}(2, \mathbb{C})$ such that $\tau(A_1)=A_2, \tau\left(A_2\right)=A_3$ and $\tau$ has order $n$.
\end{parts}
