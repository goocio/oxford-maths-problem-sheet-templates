...
\part%7a
Show that either:
(1) there is a normal subgroup $N$ of order 5 and a subgroup $H$ of order 3, or
(2) there is a normal subgroup $N$ of order 3 and a subgroup $H$ of order 5.
Deduce that $G$ has a normal subgroup $K$ isomorphic to $C_{15}$.
