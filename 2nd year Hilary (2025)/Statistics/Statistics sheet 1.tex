...
\part%1b
Suppose $X_{1}, \ldots, X_{n}$ are independent Poisson $(\lambda)$ random variables. Find a function $g(\bar{X})$ such that the asymptotic variance of $g(\bar{X})$ does not depend on $\lambda$.
\end{parts}
